...
# from diffusers.utils.torch_utils import randn_tensorfrom 
...
class StyleClip(nn.Module):
    ...
    def __init__(self, feat_dim=512, model_path=None):
        ...
        self.clip, self.transform = clip.load("ViT-B/32", download_root=model_path)
        dim_in = 512
...
class StableDiffusionPipelineWithStyle(DiffusionPipeline):
    ...
    def _execution_device(self):
        ...
        hooks.
        """
        if self.unet.device != torch.device("meta") or not hasattr(self.unet, "_hf_hook"):
    ...
    def prepare_latents(self, batch_size, num_channels_latents, height, width, dtype, device, generator, latents=None):
        ...
        if latents is None:
            ...
            # randomly create latents, the above code is wrong
    ...
    def __call__(
        ...
        if style_image is not None:
            ...
            style_image = style_image.unsqueeze(0).to(self.unet.device)
...
if __name__=="__main__":
    ...
    model_path = "ant1.4_freezeunet_class_mlp_styledrop0.1_textdrop0.1_aes6.0_b40_8_lr1e-4_0.1/checkpoint-24000"
    ...
    style_image_path = "style30k/images_top10/s0283____0908_01_query_0_img_000001_1683620688085_009414253427389718.jpeg.jpg" #"/path/to/style_image"
    style_image = Image.open(style_image_path).convert('RGB')

    prompt = "A dog sitting on the grass" # 'your prompt'
    image_out = pipe(
        prompt=prompt, 
